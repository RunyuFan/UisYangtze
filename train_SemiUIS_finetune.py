...
from Segformer import Segformer_baseline, Semiformer, Semiformer_student, Semiformer_finetune
...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if  miou > miou_max:
            ...
            torch.save(model2, os.path.join(args.model_path, 'UV-Semantic_CJZY-semiformer-finetune-all-0.5-0.7#1.pth'))
            miou_max = miou
            best_epoch = epoch
        # if acc_3 > best_acc_3:
