...
class UPerNet(nn.Module):
    def __init__(self, in_channels, channel=128, num_classes=19):
        ...
        self.head = UPerHead(in_channels, channel, num_classes)
...
class UPerNet_Fuse(nn.Module):
    ...
    def __init__(self, in_channels, channel=128, num_classes=19):
        ...
        self.head_hrs = UPerHead(in_channels, channel, 64)
        self.head = UPerHead(in_channels, channel, 64)
...
if __name__ == '__main__':
    ...
    # out = head(features)
    # out = F.interpolate(out, size=x.shape[-2:], mode='bilinear', align_corners=False)
    out = UPerNet([256, 512, 1024, 2048], 128, 4)(x)
    print(out.shape)
